...
<body class="bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
    ...
    <section class="bg-gradient-to-r from-indigo-500 to-purple-500 py-16 text-white">
        <div class="max-w-7xl mx-auto px-6 text-center">
            ...
            <p class="mt-4 text-lg md:text-xl text-indigo-100">Our students shaping the future with successful careers
            </p>
        </div>
    </section>
    ...
    <div class="max-w-7xl mx-auto px-6 py-16">
        ...
        <div class="relative mb-6">
            ...
            <div id="studentSlider" class="flex overflow-x-auto space-x-6 scroll-smooth pb-4 no-scrollbar">
                ...
                <!-- Student Card -->
                <div
                    class="min-w-[300px] bg-white rounded-xl shadow-lg p-6 text-center transition transform hover:scale-105 hover:shadow-2xl">
                    <img src="https://randomuser.me/api/portraits/men/32.jpg"
                        class="w-24 h-24 mx-auto rounded-full border-4 border-indigo-500" alt="Student">
    ...
    <button onclick="slide(1)" class="absolute right-0 top-1/2 -translate-y-1/2 bg-indigo-600 text-white p-3 rounded-full shadow-lg hover:bg-indigo-700">
      ›
        ...
        <div
            class="bg-gradient-to-r from-indigo-500 to-purple-500 text-white rounded-xl p-10 shadow-lg mb-16 text-center 
        ...
        <div class="flex flex-col md:flex-row items-center gap-8">
            ...
            <!-- Left Card (Active Openings) -->
            <div id="activeOpeningsCard"
                class="bg-white border-l-4 border-indigo-500 rounded-xl shadow p-10 text-center cursor-pointer
            ...
            <!-- Right Card (New Companies Hiring) -->
            <div id="newHiringCard"
                class="bg-white border-l-4 border-purple-500 rounded-xl shadow p-10 text-center cursor-pointer
        ...
        <div id="formPopup" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
            <div class="bg-white rounded-xl shadow-lg w-96 p-8">
                <h3 class="text-xl font-bold text-gray-800 mb-4">Login to View Openings</h3>
                <form id="loginForm">
                    <input type="email" placeholder="Email" required
                        class="w-full border p-3 rounded mb-3 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                ...
                <button onclick="closePopup('formPopup')"
                    class="mt-3 text-sm text-gray-500 hover:underline">Close</button>
            </div>
        </div>

        <!-- Active Openings Popup -->
        <div id="activeOpeningsPopup"
            class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
            <div class="bg-white rounded-xl shadow-lg w-96 p-8 text-center animate-fadeIn">
                <h3 class="text-2xl font-bold text-indigo-600 mb-4">🎉 Active Openings</h3>
                <p class="text-gray-600 text-center mb-4">Currently <span class="font-bold text-indigo-600">12</span>
                ...
                <button onclick="closePopup('activeOpeningsPopup')"
        ...
        <!-- New Companies Hiring Popup -->
        <div id="newHiringPopup"
            class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
            <div class="bg-white rounded-xl shadow-lg w-96 p-8 text-center animate-fadeIn">
                <h3 class="text-2xl font-bold text-purple-600 mb-4">🎉 New Companies Hiring</h3>
                <p class="text-gray-600 text-center mb-4">Currently <span class="font-bold text-purple-600">08</span>
                    companies are hiring:</p>
                <ul class="list-disc list-inside text-left space-y-2 text-gray-700">
                    <li>Uber</li>
                    <li>PayPal</li>
                ...
                <button onclick="closePopup('newHiringPopup')"
                    class="mt-6 bg-purple-600 text-white px-6 py-2 rounded-lg hover:bg-purple-700 transition">
                    Close
                </button>
            </div>
        </div>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", () => {
                ...
                // Popup logic
                const activeCard = document.getElementById("activeOpeningsCard");
                const newCard = document.getElementById("newHiringCard");
                const formPopup = document.getElementById("formPopup");
                const loginForm = document.getElementById("loginForm");
                let currentPopup = null;

                // Card click opens login form first
                activeCard.addEventListener("click", () => {
                    currentPopup = 'activeOpeningsPopup';
                    formPopup.classList.remove("hidden");
                });
                newCard.addEventListener("click", () => {
                    currentPopup = 'newHiringPopup';
                    formPopup.classList.remove("hidden");
                });

                // Submit login opens respective popup
                loginForm.addEventListener("submit", (e) => {
                    e.preventDefault();
                    formPopup.classList.add("hidden");
                    if (currentPopup) document.getElementById(currentPopup).classList.remove("hidden");
                });
            });
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                ...
                <div>
                    ...
                    <p class="text-gray-400 mb-4">
                        Autodesk Authorized CAD/CAM Training Institute providing industry-standard education since
                        2017.
                    </p>
