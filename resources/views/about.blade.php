...
<body>
    ...
    ============================================= -->
                ...
                <div class="wsmobileheader clearfix">
                    <span
                        class="smllogo md:max-lg:!block md:max-lg:!mt-[22px] md:max-lg:!pl-[22px] sm:max-md:!block sm:max-md:!mt-[23px] sm:max-md:!pl-[18px] xsm:max-sm:!block xsm:max-sm:!mt-[23px] xsm:max-sm:!pl-[16px]"><img
                            ...
                            src="front/images/logo-blue.png" alt="mobile-logo"></span>
                    ...
                    <div class="wsmainwp clearfix">
                        ...
                        <div class="desktoplogo">
                            <a href="demo-1.html" class="logo-black">
                                <img class="light-theme-img w-auto max-w-[inherit] !max-h-[38px] lg:max-xl:!max-h-[34px] inline-block"
                                    src="front/images/logo-blue.png" alt="logo">
                                <img class="dark-theme-img w-auto max-w-[inherit] !max-h-[38px] lg:max-xl:!max-h-[34px]"
                                    src="front/images/logo-blue-white.png" alt="logo">
                            </a>
                        </div>
                        <!-- HEADER WHITE LOGO -->
                        <div class="desktoplogo">
                            <a href="demo-1.html" class="logo-white">
                                <img class=" w-auto max-w-[inherit] !max-h-[38px] lg:max-xl:!max-h-[34px] inline-block"
                                    src="front/images/logo-blue-white.png" alt="logo"></a>
                        </div>
                        <!-- MAIN MENU -->
                        <nav class="wsmenu clearfix">
                            <ul class="wsmenu-list nav-theme">
                                ...
                                <li class="nl-simple" aria-haspopup="true"><a href="projects.html"
                                        class="h-link">Case
                                        Studies</a>
                                </li>
                                <!-- SIMPLE NAVIGATION LINK -->
                                ...
                                <!-- SIMPLE NAVIGATION LINK -->
                                <li class="nl-simple" aria-haspopup="true"><a href="faqs.html"
                                        class="h-link">FAQs</a>
                                </li>
                                <!-- SIGN IN LINK -->
                                ...
                                <li class="nl-simple" aria-haspopup="true">
                                    <a href="signup-2.html"
                                        class="btn  !rounded-[4px]  btn--theme hover--theme last-link">Get
                                        Started</a>
                                </li>
                            </ul>
                        </nav>
        ...
        <!-- ABOUT-2
                     ============================================= -->
        <section id="about-2"
            class="rel inner-page-hero about-section division pt-[180px] lg:max-xl:pt-[160px] md:max-lg:!mt-[80px] md:max-lg:pt-[70px]">
            <!-- ABOUT-2 TITLE -->
            <div class="container">
                <div class="flex flex-wrap mx-[calc(-0.5*_1.5rem)] ">
                    <div
                        class="md:w-11/12 lg:max-xl:w-10/12 xl:w-9/12 w-full flex-[0_0_auto] px-[calc(0.5*_1.5rem)] max-w-full">
                        <div class="about-2-title mb--60 xl:!mb-[60px] lg:max-xl:!mb-[50px] md:max-lg:!mb-[50px] ">
                            <!-- Title -->
                            <h2
                                class="s-52 w--700 xl:!text-[3.25rem] lg:max-xl:!text-[3rem] md:max-lg:!text-[2.79411rem] sm:max-md:!text-[2.375rem] xsm:max-sm:!text-[2.0625rem] !font-bold leading-[1.25] font-Jakarta sm:max-md:!leading-[1.35] xsm:max-sm:!leading-[1.35] mb--30 xl:!mb-[30px]">
                                We provide solutions for your creative ideas</h2>
                            <!-- Text -->
                ...
                <div class="flex flex-wrap mx-[calc(-0.5*_1.5rem)] ">
                    ...
                    <div
                        ...
                        <div class="text-end">
                            <!-- IMAGE-1 -->
                            <div
                                class="about-2-img a-2-1 rounded-[12px] ml-[13%] mb--30 !mb-[30px] lg:max-xl:ml-[3%] md:max-lg:ml-[-10%] md:max-lg:!mb-[20px] overflow-hidden">
                                <img class="img-fluid" src="front/images/a2-1.jpg" alt="about-image">
                            </div>
                            <!-- IMAGE-2 -->
                            <div class="about-2-img a-2-2 rounded-[12px ml-[-10%] md:max-lg:ml-[-20%] overflow-hidden">
                                <img class="img-fluid" src="front/images/a2-2.jpg" alt="about-image">
                            </div>
                        </div>
                    </div>
                    <!-- END IMAGES-1 -->
                    ...
                    <div
                        ...
                        <!-- IMAGE-3 -->
                        <div
                            class="about-2-img a-2-3 rounded-[12px] mr-[-10%] mb--30 !mb-[30px] md:max-lg:mr-[-8%] md:max-lg:!mb-[20px] overflow-hidden">
                            <img class="img-fluid" src="front/images/a2-3.jpg" alt="about-image">
                        </div>
                        <div class="flex flex-wrap mx-[calc(-0.5*_1.5rem)] ">
                            <!-- TEXT -->
                            <div
                                class="md:w-7/12 lg:max-xl:w-6/12 xl:w-6/12 w-full flex-[0_0_auto] px-[calc(0.5*_1.5rem)] max-w-full">
                                <div
                                    class="a2-txt bg--black-400 pattern-01 bg--fixed color--white rounded-[12px] p-[20px_30px_35px] lg:max-xl:pt-[15px] lg:max-xl:!pb-[30px] lg:max-xl:px-[20px] md:max-lg:pt-[12px] md:max-lg:!pb-[20px] md:max-lg:px-[15px] sm:max-md:pt-[20px] sm:max-md:!pb-[40px] sm:max-md:px-[30px] xsm:max-sm:pt-[15px] xsm:max-sm:!pb-[30px] xsm:max-sm:px-[20px] bg-no-repeat bg-[center_center] bg-cover bg-[url(./front/images/pattern-01.png)] bg-scroll w-full">
                                    <!-- Icon -->
                                    <div
                                        class="a2-txt-quote ico-40 opacity-20 relative mb-[-45px] lg:max-xl:relative lg:max-xl:-mb-[40px] md:max-lg:relative md:max-lg:!mb-[-35px] sm:max-md:relative sm:max-md:-mb-[40px] xsm:max-sm:relative xsm:max-sm:-mb-[40px] opacity-20">
                                        <span class="flaticon-quote"></span>
                                    </div>
                                    <!-- Text -->
                                    <p>Nullam tempor pretium a gravida donec congue ipsum porta justo integer dolor odio
                                        auctor a neque suscipit an ipsum integer congue purus at pretium turpis egestas
                                        and
                                        volute laoreet quaerat
                                    </p>
                                    <!-- Author -->
                                    <p
                                        class="a2-txt-author leading-[1.45] font-medium mt-[18px] !mb-0 lg:max-xl:!mt-[10px] lg:max-xl:!text-[1.0625rem] md:max-lg:!text-[1.1rem] sm:max-md:!text-[1.125rem] xsm:max-sm:!text-[1.125rem]">
                                        Charlie Cheever <span
                                            class=" block !font-light lg:max-xl:!text-[0.95rem] lg:max-xl:!mt-px md:max-lg:!text-[0.95rem] md:max-lg:!mt-px sm:max-md:!text-[0.975rem] sm:max-md:!mt-px xsm:max-sm:!text-[0.975rem] xsm:max-sm:!mt-px">CEO
                                            & CO-FOUNDER</span></p>
                                </div>
                            </div>
                            <!-- IMAGE-4 -->
                            <div
                                class="md:w-5/12 lg:max-xl:w-6/12 xl:w-6/12 w-full flex-[0_0_auto] px-[calc(0.5*_1.5rem)] max-w-full">
                                <div
                                    class="about-2-img a-2-4 rounded-[12px] mr-[-10%] md:max-lg:mr-[-20%] overflow-hidden">
                                    <img class="img-fluid" src="front/images/a2-4.jpg" alt="about-image">
                                </div>
                            </div>
                        </div>
                        <!-- End row -->
        ...
        <!-- ABOUT-3
                     ============================================= -->
        <div id="about-3"
            class=" pt--100 pt-[100px] lg:max-xl:pt-[80px] md:max-lg:pt-[70px]  about-section division">
            <div class="container">
                <div class="flex flex-wrap mx-[calc(-0.5*_1.5rem)] ">
                    <!-- ABOUT-3 TEXT -->
                    <div
                    ...
                    <div
                        ...
                        <div id="a3-2" class="txt-block">
                            ...
                            <h5
                                class="s-24 w--700 xl:!mb-[20px] lg:max-xl:!mb-[18px] md:max-lg:!mb-[18px] sm:max-md:!mb-[18px] xl:!text-[1.5rem] lg:max-xl:!text-[1.375rem] md:max-lg:!text-[1.470588rem] sm:max-md:!text-[1.625rem] xsm:max-sm:!text-[1.4375rem] !font-bold leading-[1.35] font-Jakarta sm:max-md:!leading-[1.4] xsm:max-sm:!leading-[1.4]">
                                We deliver results</h5>
                            <!-- Text -->
                            <p>Nemo ipsam egestas volute turpis egestas ipsum and purus sapien ultrice an aliquam
                                quaerat
                                ipsum augue turpis sapien cursus congue magna purus quaerat at ligula purus egestas
                                magna
                                cursus undo varius purus magnis sapien quaerat
                            </p>
                            <!-- Text -->
                            <p class="!mb-0">Egestas volute nemo ipsam turpis egestas ipsum and purus sapien ultrice
                                an
                                aliquam quaerat ipsum augue turpis sapien cursus congue magna purus quaerat at ligula
                                purus egestas magna cursus undo varius purus quaerat sapien magnis
                            </p>
                        </div>
                    </div>
                    <!-- END ABOUT-3 TEXT -->
        ...
        <!-- STATISTIC-5
                     ============================================= -->
        <div id="statistic-5"
            class=" py--100 py-[100px] lg:max-xl:py-[80px] md:max-lg:py-[70px]  statistic-section division">
            <div class="container">
                <!-- STATISTIC-1 WRAPPER -->
        ...
        <!-- TEXT CONTENT
                     ============================================= -->
        <section
            class="bg--04 bg--fixed py--100 py-[100px] lg:max-xl:py-[80px] md:max-lg:py-[70px] ct-01 content-section division bg-[url(./front/images/bg-04.jpg)] bg-no-repeat bg-[center_center] bg-cover bg-scroll sm:max-md:w-auto xsm:max-sm:w-auto w-full">
            <div class="container">
                <div class="flex flex-wrap mx-[calc(-0.5*_1.5rem)]  items-center">
                    ...
                    <div
                        ...
                        <div class="txt-block left-column wow fadeInRight">
                            <!-- Section ID -->
                            <span
                                class="section-id block !text-[0.85rem] leading-none !font-bold !tracking-[0.5px] uppercase xl:!mb-[35px] lg:max-xl:!mb-[30px] md:max-lg:!mb-[25px] sm:max-md:!mb-[25px] font-Jakarta">Co-founder
                                at Martex</span>
                            <!-- Title -->
                            <h2
                                ...
                                Henry Adams</h2>
                            <!-- Text -->
                            <p class="p-lg">&quot;Sodales tempor sapien diam purus ipsum quaerat and volute
                    ...
                    <div
                        ...
                        <div
                            ...
                            <!-- Preview Image -->
                            <img class="img-fluid rounded-[20px] inline-block" src="front/images/img-17.jpg"
                                alt="video-preview">
                        </div>
                    </div>
                </div>
        ...
        <section id="features-11"
            ...
            <div class="container">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <h2
                                ...
                                We make your business gain more revenue at a glance</h2>
                            <!-- Text -->
                            <p
                ...
                <div class="fbox-wrapper">
                    <div class="flex flex-wrap mx-[calc(-0.5*_1.5rem)]  row-cols-1 row-cols-md-2 rows-3">
                        <!-- FEATURE BOX #1 -->
                        <div
                            class="md:w-6/12 lg:max-xl:w-6/12 xl:w-6/12 flex-[0_0_auto] w-full max-w-full px-[calc(0.5*_1.5rem)]">
                            <div
                                class="fbox-11 flex relative items-stretch justify-start [flex-flow:row_wrap] !mb-[40px]  fb-1 wow fadeInUp">
                                <!-- Icon -->
                                <div class="fbox-ico-wrap relative mr-[25px] md:max-lg:mr-[18px]">
                                    <div class="fbox-ico ico-50 mt-[4px] !mb-[20px] xsm:max-sm:!mb-[20px]">
                                        <div class="shape-ico color--theme relative inline-block !m-[0_auto]">
                                            <!-- Vector Icon -->
                                            <span class="flaticon-graphics relative z-[2] color--theme"></span>
                                            <!-- Shape -->
                                            <svg class="xl:!w-[130px] xl:!h-[130px] top-[-40px] left-[calc(50%_-_70px)] lg:max-xl:!w-[110px] lg:max-xl:!h-[110px] lg:max-xl:top-[-35px] lg:max-xl:left-[calc(50%_-_60px)] md:max-lg:!w-[95px] md:max-lg:!h-[95px] md:max-lg:top-[-30px] md:max-lg:left-[calc(50%_-_52px)] sm:max-md:!w-[125px] sm:max-md:!h-[125px] sm:max-md:top-[-40px] sm:max-md:left-[calc(50%_-_70px)] xsm:max-sm:!w-[120px] xsm:max-sm:!h-[120px] xsm:max-sm:top-[-35px] xsm:max-sm:left-[calc(50%_-_65px)] !absolute z-[1]"
                                ...
                                <!-- End Icon -->
                                <!-- Text -->
                                <div class="fbox-txt overflow-hidden flex-1 max-w-full">
                                    <h6
                                        class="s-22 w--700 xl:!text-[1.375rem] lg:max-xl:!text-[1.25rem] md:max-lg:!text-[1.397058rem] sm:max-md:!text-[1.4375rem] xsm:max-sm:!text-[1.3125rem] !font-bold xl:!mb-[10px] lg:max-xl:!mb-[12px] md:max-lg:!mb-[12px] xsm:max-sm:!mb-[15px] leading-[1.35] font-Jakarta sm:max-md:!leading-[1.4] xsm:max-sm:!leading-[1.4]">
                                        Market Research</h6>
                                    <p class="!mb-0">Porta semper lacus cursus feugiat primis ultrice ligula risus
                                        ociis auctor and
                        ...
                        <div
                            class="md:w-6/12 lg:max-xl:w-6/12 xl:w-6/12 flex-[0_0_auto] w-full max-w-full px-[calc(0.5*_1.5rem)]">
                            <div
                                class="fbox-11 flex relative items-stretch justify-start [flex-flow:row_wrap] mb-[40px]  fb-2 wow fadeInUp">
                                <!-- Icon -->
                                <div class="fbox-ico-wrap relative mr-[25px] md:max-lg:mr-[18px]">
                                    <div class="fbox-ico ico-50 mt-[4px] !mb-[20px] xsm:max-sm:!mb-[20px]">
                                        <div class="shape-ico color--theme relative inline-block !m-[0_auto]">
                                            <!-- Vector Icon -->
                                            <span class="flaticon-idea relative z-[2] color--theme"></span>
                                            <!-- Shape -->
                                            <svg class="xl:!w-[130px] xl:!h-[130px] top-[-40px] left-[calc(50%_-_70px)] lg:max-xl:!w-[110px] lg:max-xl:!h-[110px] lg:max-xl:top-[-35px] lg:max-xl:left-[calc(50%_-_60px)] md:max-lg:!w-[95px] md:max-lg:!h-[95px] md:max-lg:top-[-30px] md:max-lg:left-[calc(50%_-_52px)] sm:max-md:!w-[125px] sm:max-md:!h-[125px] sm:max-md:top-[-40px] sm:max-md:left-[calc(50%_-_70px)] xsm:max-sm:!w-[120px] xsm:max-sm:!h-[120px] xsm:max-sm:top-[-35px] xsm:max-sm:left-[calc(50%_-_65px)] !absolute z-[1]"
                                                viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                                                <path
                        ...
                        <div
                            class="md:w-6/12 lg:max-xl:w-6/12 xl:w-6/12 flex-[0_0_auto] w-full max-w-full px-[calc(0.5*_1.5rem)]">
                            <div
                                class="fbox-11 flex relative items-stretch justify-start [flex-flow:row_wrap] mb-[40px]  fb-3 wow fadeInUp">
                                <!-- Icon -->
                                <div class="fbox-ico-wrap relative mr-[25px] md:max-lg:mr-[18px]">
                                    <div class="fbox-ico ico-50 mt-[4px] !mb-[20px] xsm:max-sm:!mb-[20px]">
                                        <div class="shape-ico color--theme relative inline-block !m-[0_auto]">
                                            <!-- Vector Icon -->
                                            <span class="flaticon-graphic relative z-[2] color--theme"></span>
                                            <!-- Shape -->
                                            <svg class="xl:!w-[130px] xl:!h-[130px] top-[-40px] left-[calc(50%_-_70px)] lg:max-xl:!w-[110px] lg:max-xl:!h-[110px] lg:max-xl:top-[-35px] lg:max-xl:left-[calc(50%_-_60px)] md:max-lg:!w-[95px] md:max-lg:!h-[95px] md:max-lg:top-[-30px] md:max-lg:left-[calc(50%_-_52px)] sm:max-md:!w-[125px] sm:max-md:!h-[125px] sm:max-md:top-[-40px] sm:max-md:left-[calc(50%_-_70px)] xsm:max-sm:!w-[120px] xsm:max-sm:!h-[120px] xsm:max-sm:top-[-35px] xsm:max-sm:left-[calc(50%_-_65px)] !absolute z-[1]"
                                                viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                                                <path
                        ...
                        <div
                            class="md:w-6/12 lg:max-xl:w-6/12 xl:w-6/12 flex-[0_0_auto] w-full max-w-full px-[calc(0.5*_1.5rem)]">
                            <div
                                class="fbox-11 flex relative items-stretch justify-start [flex-flow:row_wrap] mb-[40px]  fb-4 wow fadeInUp">
                                <!-- Icon -->
                                <div class="fbox-ico-wrap relative mr-[25px] md:max-lg:mr-[18px]">
                                    <div class="fbox-ico ico-50 mt-[4px] !mb-[20px] xsm:max-sm:!mb-[20px]">
                                        <div class="shape-ico color--theme relative inline-block !m-[0_auto]">
                                            <!-- Vector Icon -->
                                            <span class="flaticon-wireframe relative z-[2] color--theme"></span>
                                            <!-- Shape -->
                                            <svg class="xl:!w-[130px] xl:!h-[130px] top-[-40px] left-[calc(50%_-_70px)] lg:max-xl:!w-[110px] lg:max-xl:!h-[110px] lg:max-xl:top-[-35px] lg:max-xl:left-[calc(50%_-_60px)] md:max-lg:!w-[95px] md:max-lg:!h-[95px] md:max-lg:top-[-30px] md:max-lg:left-[calc(50%_-_52px)] sm:max-md:!w-[125px] sm:max-md:!h-[125px] sm:max-md:top-[-40px] sm:max-md:left-[calc(50%_-_70px)] xsm:max-sm:!w-[120px] xsm:max-sm:!h-[120px] xsm:max-sm:top-[-35px] xsm:max-sm:left-[calc(50%_-_65px)] !absolute z-[1]"
                                                viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                                                <path
                        ...
                        <div
                            class="md:w-6/12 lg:max-xl:w-6/12 xl:w-6/12 flex-[0_0_auto] w-full max-w-full px-[calc(0.5*_1.5rem)]">
                            <div
                                class="fbox-11 flex relative items-stretch justify-start [flex-flow:row_wrap] mb-[40px]  fb-5 wow fadeInUp">
                                <!-- Icon -->
                                <div class="fbox-ico-wrap relative mr-[25px] md:max-lg:mr-[18px]">
                                    <div class="fbox-ico ico-50 mt-[4px] !mb-[20px] xsm:max-sm:!mb-[20px]">
                                        <div class="shape-ico color--theme relative inline-block !m-[0_auto]">
                                            <!-- Vector Icon -->
                                            <span class="flaticon-trophy relative z-[2] color--theme"></span>
                                            <!-- Shape -->
                                            <svg class="xl:!w-[130px] xl:!h-[130px] top-[-40px] left-[calc(50%_-_70px)] lg:max-xl:!w-[110px] lg:max-xl:!h-[110px] lg:max-xl:top-[-35px] lg:max-xl:left-[calc(50%_-_60px)] md:max-lg:!w-[95px] md:max-lg:!h-[95px] md:max-lg:top-[-30px] md:max-lg:left-[calc(50%_-_52px)] sm:max-md:!w-[125px] sm:max-md:!h-[125px] sm:max-md:top-[-40px] sm:max-md:left-[calc(50%_-_70px)] xsm:max-sm:!w-[120px] xsm:max-sm:!h-[120px] xsm:max-sm:top-[-35px] xsm:max-sm:left-[calc(50%_-_65px)] !absolute z-[1]"
                                                viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                                                <path
                        ...
                        <div
                            class="md:w-6/12 lg:max-xl:w-6/12 xl:w-6/12 flex-[0_0_auto] w-full max-w-full px-[calc(0.5*_1.5rem)]">
                            <div
                                class="fbox-11 flex relative items-stretch justify-start [flex-flow:row_wrap] fb-6 wow fadeInUp">
                                <!-- Icon -->
                                <div class="fbox-ico-wrap relative mr-[25px] md:max-lg:mr-[18px]">
                                    <div class="fbox-ico ico-50 mt-[4px] !mb-[20px] xsm:max-sm:!mb-[20px]">
                                        <div class="shape-ico color--theme relative inline-block !m-[0_auto]">
                                            <!-- Vector Icon -->
                                            <span class="flaticon-search-engine-1 relative z-[2] color--theme"></span>
                                            <!-- Shape -->
                                            <svg class="xl:!w-[130px] xl:!h-[130px] top-[-40px] left-[calc(50%_-_70px)] lg:max-xl:!w-[110px] lg:max-xl:!h-[110px] lg:max-xl:top-[-35px] lg:max-xl:left-[calc(50%_-_60px)] md:max-lg:!w-[95px] md:max-lg:!h-[95px] md:max-lg:top-[-30px] md:max-lg:left-[calc(50%_-_52px)] sm:max-md:!w-[125px] sm:max-md:!h-[125px] sm:max-md:top-[-40px] sm:max-md:left-[calc(50%_-_70px)] xsm:max-sm:!w-[120px] xsm:max-sm:!h-[120px] xsm:max-sm:top-[-35px] xsm:max-sm:left-[calc(50%_-_65px)] !absolute z-[1]"
                                                viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                                                <path
                ...
                <div class="flex flex-wrap mx-[calc(-0.5*_1.5rem)]  justify-center">
                    <div
                        ...
                        <div
                            ...
                            <h5
                                class="s-20 !text-[1.25rem] lg:max-xl:!text-[1.18755rem] md:max-lg:!text-[1.397058rem] sm:max-md:!text-[1.4375rem] xsm:max-sm:!text-[1.3125rem] leading-[1.35] font-Jakarta sm:max-md:!leading-[1.4] xsm:max-sm:!leading-[1.4]">
            ...
            <div class="container">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <h2
                                ...
                                All we do is dream and craft amazing products</h2>
                            <!-- Text -->
                            <p
                                ...
                                <div
                                    ...
                                    <div class="hover-overlay w-full h-auto overflow-hidden relative">
                                        <img class="img-fluid overflow-hidden transition-transform duration-[400ms] scale-100 group-hover:!scale-105"
                                            src="front/images/team-1.jpg" alt="team-member-foto">
                                        <div
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="hover-overlay w-full h-auto overflow-hidden relative">
                                        <img class="img-fluid overflow-hidden transition-transform duration-[400ms] scale-100 group-hover:!scale-105"
                                            src="front/images/team-2.jpg" alt="team-member-foto">
                                        <div
                                            class="item-overlay opacity-0 !absolute w-full h-full transition-all duration-[400ms] ease-[ease-in-out] left-0 top-0 bg-[rgba(20,20,20,0.25)] group-hover:opacity-[0.45]">
                                        </div>
                                    </div>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="hover-overlay w-full h-auto overflow-hidden relative">
                                        <img class="img-fluid overflow-hidden transition-transform duration-[400ms] scale-100 group-hover:!scale-105"
                                            src="front/images/team-3.jpg" alt="team-member-foto">
                                        <div
                                            class="item-overlay opacity-0 !absolute w-full h-full transition-all duration-[400ms] ease-[ease-in-out] left-0 top-0 bg-[rgba(20,20,20,0.25)] group-hover:opacity-[0.45]">
                                        </div>
                                    </div>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="hover-overlay w-full h-auto overflow-hidden relative">
                                        <img class="img-fluid overflow-hidden transition-transform duration-[400ms] scale-100 group-hover:!scale-105"
                                            src="front/images/team-4.jpg" alt="team-member-foto">
                                        <div
                                            class="item-overlay opacity-0 !absolute w-full h-full transition-all duration-[400ms] ease-[ease-in-out] left-0 top-0 bg-[rgba(20,20,20,0.25)] group-hover:opacity-[0.45]">
                                        </div>
                                    </div>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="hover-overlay w-full h-auto overflow-hidden relative">
                                        <img class="img-fluid overflow-hidden transition-transform duration-[400ms] scale-100 group-hover:!scale-105"
                                            src="front/images/team-5.jpg" alt="team-member-foto">
                                        <div
                                            class="item-overlay opacity-0 !absolute w-full h-full transition-all duration-[400ms] ease-[ease-in-out] left-0 top-0 bg-[rgba(20,20,20,0.25)] group-hover:opacity-[0.45]">
                                        </div>
                                    </div>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="hover-overlay w-full h-auto overflow-hidden relative">
                                        <img class="img-fluid overflow-hidden transition-transform duration-[400ms] scale-100 group-hover:!scale-105"
                                            src="front/images/team-6.jpg" alt="team-member-foto">
                                        <div
                                            class="item-overlay opacity-0 !absolute w-full h-full transition-all duration-[400ms] ease-[ease-in-out] left-0 top-0 bg-[rgba(20,20,20,0.25)] group-hover:opacity-[0.45]">
                                        </div>
                                    </div>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="hover-overlay w-full h-auto overflow-hidden relative">
                                        <img class="img-fluid overflow-hidden transition-transform duration-[400ms] scale-100 group-hover:!scale-105"
                                            src="front/images/team-7.jpg" alt="team-member-foto">
                                        <div
                                            class="item-overlay opacity-0 !absolute w-full h-full transition-all duration-[400ms] ease-[ease-in-out] left-0 top-0 bg-[rgba(20,20,20,0.25)] group-hover:opacity-[0.45]">
                                        </div>
                                    </div>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="hover-overlay w-full h-auto overflow-hidden relative">
                                        <img class="img-fluid overflow-hidden transition-transform duration-[400ms] scale-100 group-hover:!scale-105"
                                            src="front/images/team-13.jpg" alt="team-member-foto">
                                        <div
                                            class="item-overlay opacity-0 !absolute w-full h-full transition-all duration-[400ms] ease-[ease-in-out] left-0 top-0 bg-[rgba(20,20,20,0.25)] group-hover:opacity-[0.45]">
                                        </div>
                                    </div>
                ...
                <div class="flex flex-wrap mx-[calc(-0.5*_1.5rem)] ">
                    <div class="flex-[0_0_auto] w-full max-w-full px-[calc(0.5*_1.5rem)]">
                        <div class="more-btn !text-center  mt-[20px]  wow fadeInUp">
                        ...
                        <div class="flex flex-wrap mx-[calc(-0.5*_1.5rem)]  items-center">
                            ...
                            <div
                                ...
                                <div class="txt-block left-column wow fadeInRight">
                                    <!-- Section ID -->
                                    <span
                                        class="section-id font-Jakarta block !text-[0.85rem] leading-none !font-bold tracking-[0.5px] uppercase !mb-[35px] lg:max-xl:!text-[0.85rem] lg:max-xl:!mb-[30px] md:max-lg:!mb-[25px] sm:max-md:!mb-[25px]">Why
                                        Choose Us</span>
                                    <!-- Title -->
                                    <h2
                                        ...
                                        With knowledge, skills & hard work</h2>
                                    <!-- Text -->
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <img class="img-fluid" src="front/images/img-08.png" alt="content-image">
                                </div>
                            </div>
                        </div>
                        <!-- End row -->
                ...
                <div class="flex flex-wrap mx-[calc(-0.5*_1.5rem)]  items-center">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <img class="img-fluid" src="front/images/img-07.png" alt="content-image">
                        </div>
                    </div>
                    <!-- TEXT BLOCK -->
                    <div
                        ...
                        <div class="txt-block right-column wow fadeInLeft">
                            <!-- Section ID -->
                            <span
                                class="section-id font-Jakarta block !text-[0.85rem] leading-none !font-bold tracking-[0.5px] uppercase !mb-[35px] lg:max-xl:!text-[0.85rem] lg:max-xl:!mb-[30px] md:max-lg:!mb-[25px] sm:max-md:!mb-[25px]">Strategies
                                That Work</span>
                            <!-- Title -->
                            <h2
                                class="s-46 w--700 xl:!text-[2.875rem] lg:max-xl:!text-[2.625rem] md:max-lg:!text-[2.35294rem] sm:max-md:!text-[2.25rem] xsm:max-sm:!text-[1.8125rem] !font-bold lg:max-xl:!mb-[20px] md:max-lg:!mb-[15px] sm:max-md:!mb-[20px] xsm:max-sm:!mb-[15px] xl:!mb-[26px] leading-[1.25] font-Jakarta sm:max-md:!leading-[1.35] xsm:max-sm:!leading-[1.35]">
                                Right strategies & implementations</h2>
                            <!-- Text -->
        ...
        <!-- TESTIMONIALS-2
                     ============================================= -->
        <section id="reviews-2" class=" pt--100 pt-[100px] lg:max-xl:pt-[80px] md:max-lg:pt-[70px]  reviews-section">
            <div class="container">
                <!-- SECTION TITLE -->
                <div class="flex flex-wrap mx-[calc(-0.5*_1.5rem)]  justify-center">
                    <div
                        ...
                        <div
                            ...
                            <h2
                                class="s-50 w--700 xl:!text-[3.125rem] lg:max-xl:!text-[2.875rem] md:max-lg:!text-[2.64705rem] sm:max-md:!text-[2.375rem] xsm:max-sm:!text-[2.0625rem] !font-bold !tracking-[-0.5px] leading-[1.25] font-Jakarta sm:max-md:!leading-[1.35] xsm:max-sm:!leading-[1.35]">
                                Here’s what our amazing clients are saying</h2>
                            <!-- Text -->
                            <p
                                class="s-21 color--grey xl:!text-[1.3125rem] xl:!mt-[18px] !mb-0 lg:max-xl:!mt-[15px] lg:max-xl:!text-[1.18755rem] md:max-lg:!text-[1.32352rem] md:max-lg:!mt-[12px] sm:max-md:!text-[1.21875rem] sm:max-md:!mt-[12px] xsm:max-sm:!text-[1.1875rem] xsm:max-sm:!mt-[12px] xsm:max-sm:px-[3%] xsm:max-sm:py-0">
                                Ligula risus auctor tempus magna feugiat lacinia.</p>
                ...
                <div
                    class="reviews-2-wrapper rel shape--02 shape--whitesmoke p-[0_10px] md:max-lg:!p-0 after:absolute after:content-[''] after:z-[-1] after:w-[86%] after:!h-4/5 after:left-[7%] after:top-[13%] lg:max-xl:after:!w-[140%] lg:max-xl:after:!h-[82%] lg:max-xl:after:!left-[-20%] lg:max-xl:after:!top-[12%] md:max-lg:after:!w-[140%] md:max-lg:after:!h-[82%] md:max-lg:after:!left-[-20%] md:max-lg:after:!top-[12%] sm:max-md:after:!w-[140%] sm:max-md:after:!h-[92%] sm:max-md:after:!left-[-20%] sm:max-md:after:!top-[5.5%] xsm:max-sm:after:!left-[-20%] xsm:max-sm:after:!top-[6.5%] after:bg-[rgba(123,104,238,0.05)] ">
                    <div class="flex flex-wrap mx-[calc(-0.5*_1.5rem)]  items-center row-cols-1 row-cols-md-2">
                        ...
                        <div
                            ...
                            <div id="rw-2-1"
                                class="review-2 bg--white-100 block-shadow r-08 p-[45px_50px_35px] lg:max-xl:pt-[40px] lg:max-xl:!pb-[30px] lg:max-xl:px-[35px] md:max-lg:pt-[35px] md:max-lg:!pb-[25px] md:max-lg:px-[25px] sm:max-md:pt-[35px] sm:max-md:!pb-[30px] sm:max-md:px-[35px] xsm:max-sm:pt-[35px] xsm:max-sm:!pb-[30px] xsm:max-sm:px-[20px] rounded-[8px] !mb-[20px] md:max-lg:!mb-[12px] shadow-[0_4px_12px_0_rgba(0,0,0,0.08)]">
                                <!-- Quote Icon -->
                                <div class="review-ico ico-65 relative mt-[-25px] opacity-10 -ml-[10px]"><span
                                        class="flaticon-quote"></span></div>
                                <!-- Text -->
                                <div
                                    ...
                                    <!-- Author -->
                                    <div
                                        class="author-data clearfix mt-[15px] lg:max-xl:!mt-[8px] md:max-lg:!mt-0 sm:max-md:!mt-[20px] xsm:max-sm:!mt-[20px]">
                                        <!-- Avatar -->
                                        <div class="review-avatar float-left !m-[0_auto]">
                                            <img class="xl:!w-[64px] xl:!h-[64px] lg:max-xl:!w-[52px] lg:max-xl:!h-[52px] md:max-lg:!w-[46px] md:max-lg:!h-[46px] sm:max-md:!w-[52px] sm:max-md:!h-[52px] xsm:max-sm:!w-[52px] xsm:max-sm:!h-[52px] rounded-[100%]"
                                                src="front/images/review-author-1.jpg" alt="review-avatar">
                                        </div>
                                        <!-- Data -->
                                        <div
                                            class="review-author mt-[10px] lg:max-xl:!mt-[5px] md:max-lg:!mt-[3px] sm:max-md:!mt-[3px] xsm:max-sm:!mt-[3px] relative inline-block !text-left p-[0_0_0_15px] lg:max-xl:!pl-[12px] lg:max-xl:pr-0 lg:max-xl:py-0 md:max-lg:!pl-[12px] md:max-lg:pr-0 md:max-lg:py-0 sm:max-md:!pl-[12px] sm:max-md:pr-0 sm:max-md:py-0 xsm:max-sm:!pl-[12px] xsm:max-sm:pr-0 xsm:max-sm:py-0">
                                            <h6
                                                class="s-18 w--700 xl:!text-[1.125rem] lg:max-xl:!text-[1.125rem] md:max-lg:!text-[1.066176rem] sm:max-md:!text-[1.4375rem] xsm:max-sm:!text-[1.3125rem] !font-bold !leading-none xl:!mb-[8px] lg:max-xl:!mb-[8px] md:max-lg:!mb-[5px] sm:max-md:!mb-[8px] xsm:max-sm:!mb-[8px] font-Jakarta">
                                                Scott Boxer</h6>
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <h6
                                                class="s-18 w--700 xl:!text-[1.125rem] lg:max-xl:!text-[1.125rem] md:max-lg:!text-[1.066176rem] sm:max-md:!text-[1.4375rem] xsm:max-sm:!text-[1.3125rem] !font-bold !leading-none xl:!mb-[8px] lg:max-xl:!mb-[8px] md:max-lg:!mb-[5px] sm:max-md:!mb-[8px] xsm:max-sm:!mb-[8px] font-Jakarta">
                                                Joel Peterson</h6>
                                            <p class="p-sm !leading-none !font-light !mb-0">Internet Surfer</p>
                                        </div>
                                    </div>
                                    <!-- End Author -->
                                </div>
                        ...
                        <div
                            class="col md:max-lg:w-6/12 lg:max-xl:w-6/12 xl:w-6/12 flex-[0_0_auto] w-full max-w-full px-[calc(0.5*_1.5rem)]">
                            <div id="rw-2-3"
                                class="review-2 bg--white-100 block-shadow r-08 p-[45px_50px_35px] lg:max-xl:pt-[40px] lg:max-xl:!pb-[30px] lg:max-xl:px-[35px] md:max-lg:pt-[35px] md:max-lg:!pb-[25px] md:max-lg:px-[25px] sm:max-md:pt-[35px] sm:max-md:!pb-[30px] sm:max-md:px-[35px] xsm:max-sm:pt-[35px] xsm:max-sm:!pb-[30px] xsm:max-sm:px-[20px] rounded-[8px] shadow-[0_4px_12px_0_rgba(0,0,0,0.08)]">
                                <!-- Quote Icon -->
                                <div class="review-ico ico-65 relative mt-[-25px] opacity-10 -ml-[10px]"><span
                                        class="flaticon-quote"></span></div>
                                <!-- Text -->
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <h6
                                                class="s-18 w--700 xl:!text-[1.125rem] lg:max-xl:!text-[1.125rem] md:max-lg:!text-[1.066176rem] sm:max-md:!text-[1.4375rem] xsm:max-sm:!text-[1.3125rem] !font-bold !leading-none xl:!mb-[8px] lg:max-xl:!mb-[8px] md:max-lg:!mb-[5px] sm:max-md:!mb-[8px] xsm:max-sm:!mb-[8px] font-Jakarta">
                                                Jennifer Harper</h6>
                                            <p class="p-sm !leading-none !font-light !mb-0">App Developer</p>
                                        </div>
                                    </div>
                                    <!-- End Author -->
                                </div>
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <h6
                                                class="s-18 w--700 xl:!text-[1.125rem] lg:max-xl:!text-[1.125rem] md:max-lg:!text-[1.066176rem] sm:max-md:!text-[1.4375rem] xsm:max-sm:!text-[1.3125rem] !font-bold !leading-none xl:!mb-[8px] lg:max-xl:!mb-[8px] md:max-lg:!mb-[5px] sm:max-md:!mb-[8px] xsm:max-sm:!mb-[8px] font-Jakarta">
                                                Evelyn Martinez</h6>
                                            <p class="p-sm !leading-none !font-light !mb-0">WordPress Consultant</p>
                                        </div>
                                    </div>
                                    <!-- End Author -->
                                </div>
        ...
        <!-- RATING-1
                     ============================================= -->
        <div id="rating-1"
            class="rating-section pt-[70px] lg:max-xl:pt-[60px] md:max-lg:pt-[50px] pb--100 !pb-[100px] lg:max-xl:!pb-[80px] md:max-lg:!pb-[70px]">
            <div class="container">
                <!-- RATING TITLE -->
                <div class="flex flex-wrap mx-[calc(-0.5*_1.5rem)]  justify-center">
                    <div
        ...
        <!-- TEXT CONTENT
                     ============================================= -->
        <section
            class="bg--white-400  py--100 py-[100px] lg:max-xl:py-[80px] md:max-lg:py-[70px]  ct-03 content-section division">
            <div class="container">
                <div class="flex flex-wrap mx-[calc(-0.5*_1.5rem)]  items-center">
                    <!-- TEXT BLOCK -->
                    <div
                        class="md:w-6/12 lg:max-xl:w-5/12 xl:w-5/12 w-full flex-[0_0_auto] px-[calc(0.5*_1.5rem)] max-w-full order-last order-md-2 md:max-lg:order-2 lg:max-xl:order-2 xl:order-2">
                        <div class="txt-block left-column wow fadeInRight">
                            <!-- Section ID -->
                            <span
                                class="section-id font-Jakarta block !text-[0.85rem] leading-none !font-bold tracking-[0.5px] uppercase !mb-[35px] lg:max-xl:!text-[0.85rem] lg:max-xl:!mb-[30px] md:max-lg:!mb-[25px] sm:max-md:!mb-[25px]">One-Stop
                                Solution</span>
                            <!-- Title -->
                            <h2
                                class="s-46 w--700 xl:!text-[2.875rem] lg:max-xl:!text-[2.625rem] md:max-lg:!text-[2.35294rem] sm:max-md:!text-[2.25rem] xsm:max-sm:!text-[1.8125rem] !font-bold lg:max-xl:!mb-[20px] md:max-lg:!mb-[15px] sm:max-md:!mb-[20px] xsm:max-sm:!mb-[15px] xl:!mb-[26px] leading-[1.25] font-Jakarta sm:max-md:!leading-[1.35] xsm:max-sm:!leading-[1.35]">
                                Data-driven digital marketing</h2>
                            <!-- List -->
                            <ul class="simple-list">
                                <li class="list-item">
                    ...
                    <!-- IMAGE BLOCK -->
                    <div
                        class="md:w-6/12 lg:max-xl:w-7/12 xl:w-7/12 w-full flex-[0_0_auto] px-[calc(0.5*_1.5rem)] max-w-full order-first order-md-2 md:max-lg:order-2 lg:max-xl:order-2 xl:order-2">
                        <div class="img-block !text-center right-column wow fadeInLeft">
                    ...
                    <div
                        ...
                        <div id="bp-1-3" class="blog-post wow fadeInUp">
                            ...
                            <div class="blog-post-txt">
                                ...
                                <h6
                                    class="s-20 w--700 xl:!text-[1.25rem] lg:max-xl:!text-[1.18755rem] md:max-lg:!text-[1.397058rem] sm:max-md:!text-[1.4375rem] xsm:max-sm:!text-[1.3125rem] !font-bold xl:!mb-[15px] lg:max-xl:!mb-[12px] md:max-lg:!mb-[12px] sm:max-md:!mb-[18px] xsm:max-sm:!mb-[14px] leading-[1.35] font-Jakarta sm:max-md:!leading-[1.4] xsm:max-sm:!leading-[1.4]">
                                    <a class="text-[#353f4f] hover:!underline" href="single-post.html">Cubilia laoreet
                                        augue egestas and Martex magna impedit</a>
                                </h6>
                                <!-- Text -->
                ...
                <div class="flex flex-wrap mx-[calc(-0.5*_1.5rem)] ">
                    ...
                    <div class="xl:w-3/12 w-full flex-[0_0_auto] px-[calc(0.5*_1.5rem)] max-w-full ">
                        <div class="footer-info !mb-[40px] lg:max-xl:!mb-[50px]">
                            <img class="footer-logo w-auto max-w-[inherit] xl:!max-h-[40px] lg:max-xl:!max-h-[34px] md:max-lg:!max-h-[33px] sm:max-md:!max-h-[38px] xsm:max-sm:!max-h-[37px]"
                                src="front/images/logo-blue.png" alt="footer-logo">
                            <img class="footer-logo-dark hidden w-auto max-w-[inherit] xl:!max-h-[40px] lg:max-xl:!max-h-[34px] md:max-lg:!max-h-[33px] sm:max-md:!max-h-[38px] xsm:max-sm:!max-h-[37px]"
                                src="front/images/logo-blue-white.png" alt="footer-logo">
                        </div>
                    </div>
                    <!-- FOOTER LINKS -->
                    <div
                        ...
                        <div class="footer-links !mb-[40px] fl-1">
                            ...
                            <ul class="foo-links clearfix">
                                <li class=" w-auto block align-top clear-none !m-0 !p-0">
                                    <p class=" !font-normal !mb-[10px] md:max-lg:!mb-[8px]"><a href="/about-us">About
                                            Us</a></p>
                                </li>
                                <li class=" w-auto block align-top clear-none !m-0 !p-0">
                    ...
                    <div
                        ...
                        <div class="footer-links !mb-[40px] fl-4">
                            <!-- Title -->
                            <h6
                                class="s-17 w--700 !text-[1.0625rem] lg:max-xl:!text-[1.0625rem] !mb-[25px] lg:max-xl:!mb-[20px] md:max-lg:!text-[1.17647rem] md:max-lg:!mb-[16px] sm:max-md:!text-[1.21875rem] sm:max-md:!mb-[20px] xsm:max-sm:!text-[1.21875rem] xsm:max-sm:!mb-[20px] font-Jakarta !font-bold leading-none sm:max-md:!leading-[1.4] xsm:max-sm:!leading-[1.4]">
                                Connect With Us</h6>
                            <!-- Mail Link -->
                            <p
