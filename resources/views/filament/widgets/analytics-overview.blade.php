        ...
        <style>
            ...
            <div class="w-1/4 py-2 custom_width_25">
                <div class="p-6 bg-white rounded-xl shadow flex flex-col justify-between">
                    ...
                    <p class="text-3xl font-bold text-blue-500 custom-text-color-blue">{{ $websiteSessions }}</p>
            ...
            <div class="w-1/4 p-2 custom_width_25">
                <div class="p-6 bg-white rounded-xl shadow flex flex-col justify-between">
                    ...
                    <p class="text-3xl font-bold text-blue-500 custom-text-color-blue">{{ $buyNowClicks }}</p>
            ...
            <div class="w-1/4 p-2 custom_width_25">
                <div class="p-6 bg-white rounded-xl shadow flex flex-col justify-between">
                    ...
                    <p class="text-3xl font-bold text-blue-500 custom-text-color-blue">{{ $transactions }}</p>
                    <p class="text-green-500 text-sm mt-2">↑ 0% up compared to last 7 days</p>
                </div>
            </div>
            ...
            <div class="w-1/4 py-2 custom_width_25">
                <div class="p-6 bg-white rounded-xl shadow flex flex-col justify-between">
                    ...
                    <p class="text-3xl font-bold text-blue-500 custom-text-color-blue">{{ $revenue }}</p>
                    <p class="text-green-500 text-sm mt-2">↑ 0% up compared to last 7 days</p>
                </div>
            </div>
        </div>
