...
<body>
    ...
    <section id="top-nav" class="bg-secondary">
        <div class="text-center px-md-3 py-md-2">
            <p class="text-white py-1 m-0">Get your first course at 50% Discount. Offer lasts for the first 50 students
                only.
            ...
            <div class="main-logo d-lg-none">
                <a href="/">
                    @if (setting('general.institute_logo') != null)
                        <img src="{{ '/storage' . '/' . setting('general.institute_logo') }}" alt="logo"
                            class="img-fluid">
                    @else
        ...
        <div class="container-fluid d-lg-none">
            <div class="d-flex  align-items-end mt-3">
                <ul class="d-flex  align-items-center list-unstyled m-0">
                    ...
                    <li>
                        <a href="#" class="me-3" data-bs-toggle="offcanvas"
                            data-bs-target="#offcanvasSearch" aria-controls="offcanvasSearch">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px">
                                <use href="#search" />
                            </svg> </a>
        ...
        <div class="container-xl">
            <div class="row gx-lg-5 gx-3 mb-lg-0 mb-4">
                <div class="col-lg-6 mb-lg-0 mb-4 text-lg-start  text-center">
                    <h2 class="fs-4 fw-bold  mb-3  mar_top">How Does This Architectural Assistant course in cadadda
                        Jodhpur Work?</h2>
                    <p class="fs-6 text-muted mb-4"></p>
                    <button
                        class="btn btn-primary py-3 px-4 fs-5 fw-bold rounded-3 hover-shadow mx-lg-0 mx-auto d-lg-block d-none">Apply
                        Now</button>
                </div>
                <div class="col-lg-6">
                    <div class="row row-cols-1 row-cols-md-2 g-4">
                        <div class="col w-100 ">
                            <div
                                class="dashed p-4  rounded-start  border border-dark  border-end-0  position-relative">
                                <div class="card-body d-flex align-items-center">
                                    <div class="d-flex align-items-center me-md-3 text-center position-relative">
                                        <img alt="Learn" width="85" height="85"
                                            src="https://d2kr1rbctelohj.cloudfront.net/images/courses-details/learn-icon.svg"
                                            class="img-fluid">
                                    </div>
                                    <div class="content">
                                        <h3 class="fs-5 fw-bold mb-2">Learn <span
                                                class="badge bg-primary text-light ms-2">Live Classes <img
                                                    src="https://d2kr1rbctelohj.cloudfront.net/images/icons/ellipse-icon.svg"
                                                    alt="ellips-icon" width="4" height="4"
                                                    class="ms-1"></span></h3>
                                        <p class="fs-6 text-muted mb-0">Upskill yourself by gaining insights from
                                            leading professionals' vast experience.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col  w-100 " style="translate: 4px 0px; margin-top: -1px;">
                            <div
                                class="dashed p-4  border-start-0 rounded-end border-bottom border-end border-dark position-relative">
                                <div class="card-body d-flex align-items-center">
                                    <div class="d-flex align-items-center me-md-3 text-center position-relative">
                                        <img alt="Practice" width="85" height="85"
                                            src="https://d2kr1rbctelohj.cloudfront.net/images/courses-details/practice-icon.svg"
                                            class="img-fluid">
                                    </div>
                                    <div class="content">
                                        <h3 class="fs-5 fw-bold mb-2">Practice</h3>
                                        <p class="fs-6 text-muted mb-0">Sharpen your skills by learning through course
                                            assignments, live projects, and regular assessments and quizzes.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col mt-0 w-100">
                            <div
                                class="dashed p-4  border-start rounded-start border-bottom border-dark position-relative">
                                <div class="card-body d-flex align-items-center">
                                    <div class="d-flex align-items-center me-md-3 text-center position-relative">
                                        <img alt="Ask" width="85" height="85"
                                            src="https://d2kr1rbctelohj.cloudfront.net/images/courses-details/build-icon.svg"
                                            class="img-fluid">
                                    </div>
                                    <div class="content">
                                        <h3 class="fs-5 fw-bold mb-2">Ask</h3>
                                        <p class="fs-6 text-muted mb-0">Resolve your queries from industry experts with
                                            our dedicated one-to-one doubt-clearing sessions.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col mt-0 w-100" style="translate: 4px 0px; margin-top: -1px;">
                            <div
                                ...
                                <div class="card-body d-flex align-items-center">
                                    <div class="d-flex align-items-center me-md-3 text-center position-relative">
                                        <img alt="Build" width="85" height="85"
                                            src="https://d2kr1rbctelohj.cloudfront.net/images/courses-details/success-icon.svg"
                                            class="img-fluid">
                                    </div>
                                    <div class="content">
                                        <h3 class="fs-5 fw-bold mb-2">Build</h3>
                                        <p class="fs-6 text-muted mb-0">Craft a diverse portfolio and appealing resume,
                                            and optimize LinkedIn to showcase your data analytics skills.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <button
                class="btn btn-primary py-3 px-4 fs-5 fw-bold rounded-3 hover-shadow mx-lg-0 mx-auto d-lg-none d-block">Apply
                Now</button>
        </div>
    </section>
        ...
        <div class="container">
            <div class="d-lg-flex justify-content-between align-items-start text-dark mb-lg-5 mb-4">
                <div class="mb-lg-0 mb-4 text-lg-start text-center">
                    ...
                    <p class="fs-6 text-muted mb-0">A detailed overview of the course, including key topics,
                        objectives, and module sequence.</p>
                </div>
            ...
            <div class="mb-5 d-flex  ">
                <div class="d-flex  flex-wrap col-12 detel justify-content-between border border-dark align-self-center p-2 ">
                    ...
                    <div class="d-flex align-items-center py-2">
                        <img src="https://d2kr1rbctelohj.cloudfront.net/images/icons/mode-icon.svg" alt="mode"
                            width="25" height="25" class="me-2">
                        <div>
                    ...
                    <div class="d-flex align-items-center py-2">
                        <img src="https://d2kr1rbctelohj.cloudfront.net/images/icons/live-sessions-icon.svg"
                            alt="live sessions" width="25" height="25" class="me-2">
                        <div>
                    ...
                    <div class="d-flex align-items-center py-2">
                        <img src="https://d2kr1rbctelohj.cloudfront.net/images/icons/projects-icon.svg" alt="projects"
                            width="25" height="25" class="me-2">
                        <div>
            ...
            <div class="accordion" id="curriculumAccordion">
                ...
                <div class="accordion-item mb-3  " style="border: 1px solid black; border-radius: 5%;">
                        <button class="accordion-button collapsed d-flex justify-content-between align-items-center"
                            type="button" data-bs-toggle="collapse" data-bs-target="#module{{ $syllabuses->id }}"
                            aria-expanded="false">
                            <div class="d-lg-flex align-items-center justify-content-between w-100">
                                <h4 class="fs-16 fw-500 text-color-1 mb-0">
                                    <span class="d-lg-inline-block d-none text-secondary">Module {{ $loop->iteration }}</span>
                                    {{-- <span class="d-lg-none d-inline-block text-secondary">Module {{ $loop->iteration }}.</span> --}}
                                    {{ $syllabuses->title }}
                                </h4>
                                    ...
                                    @foreach ($syllabuses->extra_info as $index => $info)
                                        @if ($info['name'] && $info['value'])
                                            <li class="px-2 py-1 text-nowrap d-flex align-items-center">
                                                <div
                                                    class="text-color-2 min-w-19 min-h-19 sullybus-btn mx-1 text-center {{ $colors[$index % count($colors)] }}">
                                                    {{ $info['value'] }}
                                                </div>
                                                <div>{{ $info['name'] }}</div>
                                            </li>
                        ...
                        <div id="module{{ $syllabuses->id }}" class="accordion-collapse collapse"
                ...
                <div class="slider-container">
                    <div class="logo-slider">
                        @foreach ($coursetool as $tool)
                            <img src="{{ url('storage/' . $tool->Tool->image) }}" class="logo-image"
                                alt="Client Logo 1">
                        @endforeach
                    </div>
                </div>
                                ...
                                <div class="swiper-slide pe-md-5">
                                    <div class="my-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-3"> <img
                                                    src="{{ url('storage/' . $review->student->photo) }}"
