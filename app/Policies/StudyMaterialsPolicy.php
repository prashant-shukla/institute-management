...
class StudymaterialsPolicy
{
     ...
     */
    public function view(User $user, Studymaterials $studymaterials): bool
    {
     ...
     */
    public function update(User $user, Studymaterials $studymaterials): bool
    {
     ...
     */
    public function delete(User $user, Studymaterials $studymaterials): bool
    {
     ...
     */
    public function forceDelete(User $user, Studymaterials $studymaterials): bool
    {
     ...
     */
    public function restore(User $user, Studymaterials $studymaterials): bool
    {
     ...
     */
    public function replicate(User $user, Studymaterials $studymaterials): bool
    {
