...
class CenterPolicy
{
    ...
    {
        return $user->can('delete_any_center');
    }
    ...
    {
        return $user->can('force_delete_center');
    }
    ...
    {
        return $user->can('force_delete_any_center');
    }
    ...
    {
        return $user->can('restore_center');
    }
    ...
    {
        return $user->can('restore_any_center');
    }
    ...
    {
        return $user->can('replicate_center');
    }
    ...
    {
        return $user->can('reorder_center');
    }
}
