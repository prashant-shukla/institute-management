<?php
use App\Models\User;
use App\Filament\Installation\ServerRequirements;
use App\Filament\Installation\FolderPermissions;
use App\Filament\Installation\EnvironmentVariables;
use App\Filament\Installation\ApplicationSettings;
use App\Filament\Installation\InstallationFinish;
use App\Rules\DbConnection;
...
return [
    ...
    'installation_manager' => InstallationFinish::class,
    /*
    |--------------------------------------------------------------------------
    | Server Requirements
    |--------------------------------------------------------------------------
